  ...
  <div class="section-container">
    ...
    <div class="section-container__column">
      <div>
        ...
        <p>Met deze kennis heb ik de opleiding tot <a href="./mediator">mediator</a> behaald en ben ik gestart als zelfstandig ondernemer. Mijn visie is bedrijven en werknemers begeleiden naar een plezierige en langdurige werkrelatie door handvaten te geven in het communiceren met elkaar.</p>
